...
ms笔试 1. 像素渲染 打包成tuple，sort，从小到大排序，贪心记录最多渲染多少
2. 节点之间的权值最大
3. 数组中切两刀成三个链，求切的cost最小，用了三个方法，一暴力，二双指针，大的一个指针挪动， 三构建大根堆，除去开头结尾 挑出来四个最小的数，两两结合验证下标是否符合相差大于1
wy笔试 1. 数组的子数组，和为6的倍数，最大是多少 2. 最小编辑距离，改的cost是2，其他是1，结果保留两位小数 3. 优惠券满减门限T，最少花多少钱 4. 树找存在节点大于x的路径，保存在数组中，不用构造树，因为是完全二叉，空节点在list中为null，可以直接下标*2+1，下标*2+2确定左右孩子节点。 
